...
<Canvas>
	<Story name="Overview">
		<MessageBox author={{ username: 'Hello World' }} position="start" orientation="left" component={MessageText}>
			Hey! Check this out:
		</MessageBox>
		<MessageBox author={{ username: 'Hello World' }} position="end" orientation="left" component={MediaGroup}>
