...
<Canvas>
	<Story name="Overview">
		...
		<MessageBox time={new Date(Date.now() - 60000)} component={MessageEmoji} position="end" orientation="right">
			😍
		</MessageBox>
	</Story>
</Canvas>
...
Also, you can use MessageBox without avatar & time, like simple box:

<Canvas>
	<Story args={{ orientation: 'left', position: 'start', children: 'Just simple box!' }} name="Without avatar & time">
		{TextMessageTemplate.bind({})}
	</Story>
</Canvas>
